...
export const crashClean = Record({
    ...
    data: {
        ...
        location_text: 'Rt 9 EB near Speen St, Natick',
        latitude: 42.299600,
        longitude: -71.369000,
...
export const crashOffNetwork = Record({
    ...
    data: {
        ...
        location_text: 'Off roadway, wooded area N of Rt 9, Natick',
        latitude: 42.306200,
        longitude: -71.354700,
        geocode_state: 'pending',
    },
